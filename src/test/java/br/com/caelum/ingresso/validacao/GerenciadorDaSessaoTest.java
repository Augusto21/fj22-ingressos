...
public class GerenciadorDaSessaoTest {
	...
	public void preparaSessoes() {
		this.rogueOne = new Filme("Rogue One", Duration.ofMinutes(120), "SCI-FI", BigDecimal.valueOf(25));
		this.sala3D = new Sala("Sala 3D", BigDecimal.valueOf(10));
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesTermandoDentroDoHorarioDeUmaSessaoJaExistente() {
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesIniciandoDenotroDoHorarioDeUmaSessaoJaExistente() {
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
	...
	public void garanteQueDevePermitirUmaInsercaoEntreDoisFilmes() {
		...
		GerenciadorDeSessao gerenciador = new GerenciadorDeSessao(sessoes);
		assertTrue(gerenciador.cabe(sessaoDasTreze));
	}
	...
	public void garanteQueDeveNaoPermitirUmaSessaoQueTerminaNoProximoDia() {
		...
		assertFalse(gerenciador.cabe(sessaoQueTerminaAmanha));
	}
